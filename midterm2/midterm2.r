...
set.seed(2718)
w <- rep(sample(c(1:13),13,replace=FALSE),4)
...
m <- matrix(data = rexp(10,rate=3),nrow=10,ncol=10)
...
fm <- family[family$gender=="m"&family$height>71,]
...
plot(sepal.divided.petal,seq(1:150))
